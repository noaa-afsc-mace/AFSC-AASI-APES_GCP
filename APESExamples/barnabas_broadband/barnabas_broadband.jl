...
d1 = plot(p1, p2, size=(1000, 300), dpi=500, margin=20px, xticks=(tticks, tlabels), background_color_inside="#888888")
...
d3 = plot(p_epsilon, p_logprob, p_rhat, layout=(2,2), title_align=:left, size=(1000, 600))
